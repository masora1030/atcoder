...
if __name__=='__main__':
    ...
    s = sr()
    t = sr()
    s_dic = {i:0 for i in range(1,10)}
    t_dic = {i:0 for i in range(1,10)}
    for c in s[:-1]:
        s_dic[int(c)]+=1
    for c in t[:-1]:
        t_dic[int(c)]+=1
        ...
        for b in range(1,10):
            if a == b:
                if s_dic[a]+t_dic[a]+2 <= k:
                    ...
                    s_dic[a]-=1
                    t_dic[b]-=1
                    p = (k-(s_dic[a]+t_dic[a]))*(k-(s_dic[a]+t_dic[a])-1)
                    total+=p
                    if p_s>p_t:
                        count+=p
            else:
                if s_dic[a]+t_dic[a]+1 <= k and s_dic[b]+t_dic[b]+1 <= k:
                    p_s = 0
                    p_t = 0
                    s_dic[a]+=1
                    t_dic[b]+=1
                    ...
                    s_dic[a]-=1
                    t_dic[b]-=1
                    ret_a = k-(s_dic[a]+t_dic[a])
                    ret_b = k-(s_dic[b]+t_dic[b])
                    p = ret_a*ret_b
                    total+=p
                    if p_s>p_t:
                        count+=p
